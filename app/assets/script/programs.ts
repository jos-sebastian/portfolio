...
class Programs {
  ...
  constructor(gl: WebGL2RenderingContext, shaders: Shaders) {
    this.blurProgram = new Program(shaders.blurVertexShader, shaders.blurShader, gl);

    this.copyProgram = new Program(shaders.baseVertexShader, shaders.copyShader, gl);

    this.clearProgram = new Program(shaders.baseVertexShader, shaders.clearShader, gl);

    this.colorProgram = new Program(shaders.baseVertexShader, shaders.colorShader, gl);
    ...
    this.splatProgram = new Program(shaders.baseVertexShader, shaders.splatShader, gl);
    ...
    this.curlProgram = new Program(shaders.baseVertexShader, shaders.curlShader, gl);
